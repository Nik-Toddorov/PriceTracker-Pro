export const translations = {
    en: {
        ...
        "tab_history_log": "Change History",
        "history_log_title": "Price & Text Change History Log",
        "history_log_desc": "Chronological timeline of detected price drops, increases, and text changes across all monitored sites.",
        "stat_total_changes": "Total Changes",
        "stat_price_drops": "Price Drops",
        "stat_price_increases": "Price Increases",
        "stat_text_changes": "Text Changes",
        "search_history_placeholder": "Search by URL, category, or content...",
        "filter_all_types": "All Changes",
        "filter_price_drops": "📉 Price Drops",
        "filter_price_increases": "📈 Price Increases",
        "filter_text_changes": "📝 Text Changes",
        "filter_all_categories": "-- All Categories --",
        "refresh_log_btn": "🔄 Refresh Log",
        "export_log_btn": "📥 Export (JSON)",
        "clear_log_btn": "🗑️ Clear History",
        "confirm_clear_log": "Are you sure you want to clear the entire change history log?",
        "no_changes_logged": "No price or text changes have been recorded yet. When a price or text changes on a tracked site, it will be automatically recorded here.",
        "no_changes_matching_filter": "No changes match your active search or filter.",
        "prev_state_label": "Previous State",
        "new_state_label": "New State",
        "change_amount_label": "Change",
        "open_site_btn": "↗️ Open Site",
        "view_details_btn": "📈 View History / Chart",
        "delete_entry_btn": "🗑️",
        "badge_all_time_low": "⭐ All-Time Lowest Price!",
        "badge_price_drop": "📉 Price Drop",
        "badge_price_increase": "📈 Price Increase",
        "badge_text_updated": "📝 Text Updated",
        "time_ago_just_now": "just now",
        "time_ago_mins": "{m}m ago",
        "time_ago_hours": "{h}h ago",
        "time_ago_yesterday": "yesterday",
        "time_ago_days": "{d}d ago",
        "confirm_delete_log_entry": "Remove this change event from the log?",
        "log_cleared_success": "Change history log cleared successfully."
    },
    bg: {
        "app_title": "Price & Text Tracker",
        ...
        "tab_history_log": "Хронология на промените",
        "history_log_title": "Хронология на промените в цени и текстове",
        "history_log_desc": "Подробен хронологичен дневник на регистрираните спадове, повишения на цени и промени в текстове/наличности.",
        "stat_total_changes": "Общо регистрирани промени",
        "stat_price_drops": "Свалени цени",
        "stat_price_increases": "Повишени цени",
        "stat_text_changes": "Промени в текст",
        "search_history_placeholder": "Търсене по URL, категория или съдържание...",
        "filter_all_types": "Всички промени",
        "filter_price_drops": "📉 Само спадове на цени",
        "filter_price_increases": "📈 Само повишения на цени",
        "filter_text_changes": "📝 Само промени в текст",
        "filter_all_categories": "-- Всички категории --",
        "refresh_log_btn": "🔄 Опресни списъка",
        "export_log_btn": "📥 Експорт (JSON)",
        "clear_log_btn": "🗑️ Изчисти хронологията",
        "confirm_clear_log": "Сигурни ли сте, че искате да изчистите цялата хронология на промените?",
        "no_changes_logged": "Все още няма регистрирани промени в цените или текстовете. Когато настъпи промяна на наблюдаван сайт, тя ще бъде автоматично записана тук.",
        "no_changes_matching_filter": "Няма намерени промени, отговарящи на избраните филтри.",
        "prev_state_label": "Предходно състояние",
        "new_state_label": "Ново състояние",
        "change_amount_label": "Промяна",
        "open_site_btn": "↗️ Отвори сайта",
        "view_details_btn": "📈 Виж пълна история / графика",
        "delete_entry_btn": "🗑️",
        "badge_all_time_low": "⭐ Нова рекордно ниска цена!",
        "badge_price_drop": "📉 Спад в цената",
        "badge_price_increase": "📈 Повишение на цената",
        "badge_text_updated": "📝 Променен текст",
        "time_ago_just_now": "току-що",
        "time_ago_mins": "преди {m} мин",
        "time_ago_hours": "преди {h} ч",
        "time_ago_yesterday": "вчера",
        "time_ago_days": "преди {d} дни",
        "confirm_delete_log_entry": "Желаете ли да премахнете този запис от хронологията?",
        "log_cleared_success": "Хронологията на промените беше изчистена успешно."
    }
};
